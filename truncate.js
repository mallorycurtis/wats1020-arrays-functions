...
function truncateWords() {
  var longText = originalText.split(" ");
  //split the string into an array
  var numWords = longText.splice (0, wordLimit);
  //instead of finding the length and subtracting, I thought the splice function would do the same thing in less steps
  console.log (numWords.join(" ") + "...");
  //join the function back into a string and add ellipses in
}
